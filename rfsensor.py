#!/usr/bin/env python
"""
rfsensor.py v13 PrivateEyePi RF Sensor Interface
---------------------------------------------------------------------------------
                ...
                for z in range(0,numrf,1):
                        if RFList[z]==int(DevId):
                                ...
                                if globals.LCDAlarmActivity==True:
                                        ...
                                        SendToLCD([DevId,LocationList[z],0,switch,0,0,0,0,0])
                ...
                for z in range(0,numrf,1):
                        if RFList[z]==int(DevId):
                                ...
                                if globals.LCDTemperature==True:
                                        ...
                                        #RecordSet[7] : Armed/Disarmed 1=Armed, 2=Disarmed
                                        #RecordSet[8] : Date/Time
                                        SendToLCD([DevId,LocationList[z],0,3,value,0,globals.Farenheit,0,0])
                ...
                for z in range(0,numrf,1):
                        if RFList[z]==int(DevId):
                                ...
                                if globals.LCDTemperature==True:
                                        ...
                                        #RecordSet[5] : Humidity Value
                                        #RecordSet[6] : Unit of measure, 0=Centigrade, 1=Fahrenheit
                                        SendToLCD([DevId,LocationList[z],value,0,4,value2,globals.Farenheit])
        return(0)
...
def BuildRFSensorListThread():
        ...
        for i in range(numrf):
                ...
                LocationList.append(RecordSet[i][1])
